...
module.exports = function(router) {
  ...
  router.get("/api/fetch", function(req, res) {
    // This method inside the headlinesController will try and scrap new articles &save unique ones to database
    headlinesController.fetch(function(err, docs) {
      // If don't get any articles back, send this message back to the user
      if (!docs || docs.insertedCount === 0) {
        ...
        // Otherwise send back a count of how many new articles
        res.json({
  ...
  // This route handles getting all headlines from database
